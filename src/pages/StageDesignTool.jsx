...
`;
      ...
      if (roofStructure !== "none") {
        if (roofStructure === "marquee") {
          ...
          if (tent) {
            prompt += `
ROOF: White marquee tent (${tent.name}) positioned ON TOP of the base stage deck platform - **CRITICAL: The tent sits directly on the stage surface, not floating above it or suspended. ABSOLUTELY ZERO center support legs, poles, middle structures, or interior supports whatsoever. The tent must be completely open underneath with no vertical supports in the middle.**
`;
          }
